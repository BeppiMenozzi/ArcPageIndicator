package it.beppi.arcpageindicator_sample.utils;

// Classe copiata da un sito spudoratamente e leggermente modificata, che implementa un timer utilizzando un handler.
